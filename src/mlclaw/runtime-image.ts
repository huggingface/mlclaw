...
export const UNYOLO_PLUGIN_VERSION = RELEASE_CONFIG.unyoloPluginVersion;
export const HF_BROKER_VERSION = RELEASE_CONFIG.hfBrokerVersion;
export const DEFAULT_HF_BROKER_VERSION = HF_BROKER_VERSION;
export const TELEGRAM_BOT_MUX_VERSION = RELEASE_CONFIG.telegramBotMuxVersion;
